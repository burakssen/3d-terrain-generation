...
function findWasmBinary() {
    var f = '3dTerrainGeneration.wasm';
    if (!isDataURI(f)) {
      return locateFile(f);
    }
    return f;
...
var ASM_CONSTS = {
  90712: () => { if (document.fullscreenElement) return 1; },  
 90758: () => { return document.getElementById('canvas').width; },  
 90810: () => { return parseInt(document.getElementById('canvas').style.width); },  
 90878: () => { document.exitFullscreen(); },  
 90905: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 90978: () => { if (document.fullscreenElement) return 1; },  
 91024: () => { return document.getElementById('canvas').width; },  
 91076: () => { return screen.width; },  
 91101: () => { document.exitFullscreen(); },  
 91128: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 91261: () => { if (document.fullscreenElement) return 1; },  
 91307: () => { return document.getElementById('canvas').width; },  
 91359: () => { return parseInt(document.getElementById('canvas').style.width); },  
 91427: () => { if (document.fullscreenElement) return 1; },  
 91473: () => { return document.getElementById('canvas').width; },  
 91525: () => { return screen.width; },  
 91550: () => { if (document.fullscreenElement) return 1; },  
 91596: () => { return document.getElementById('canvas').width; },  
 91648: () => { return screen.width; },  
 91673: () => { document.exitFullscreen(); },  
 91700: () => { if (document.fullscreenElement) return 1; },  
 91746: () => { return document.getElementById('canvas').width; },  
 91798: () => { return parseInt(document.getElementById('canvas').style.width); },  
 91866: () => { document.exitFullscreen(); },  
 91893: () => { return screen.width; },  
 91918: () => { return screen.height; },  
 91944: () => { return window.screenX; },  
 91971: () => { return window.screenY; },  
 91998: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 92051: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 92122: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 92179: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 92250: () => { if (document.fullscreenElement) return 1; },  
 92296: () => { if (document.pointerLockElement) return 1; }
};
